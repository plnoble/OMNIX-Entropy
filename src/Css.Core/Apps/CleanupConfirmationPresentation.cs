...
public static class CleanupConfirmationPresenter
{
    public static CleanupConfirmationViewModel Create(OperationDescriptor operation, string quarantineRoot)
    {
        ...
        var isCommunityExactFiles = operation.Kind.Equals(
            CommunityRuleCacheCleanupPlanBuilder.OperationKind,
            System.StringComparison.OrdinalIgnoreCase);
        var affectedDescription = isCommunityExactFiles
            ? affectedCount + " 个精确旧缓存文件"
            : affectedCount + " 个位置";
        var beginnerLines = new[]
        {
            "Agent \u5224\u65ad\uff1a\u8fd9\u662f\u4f4e\u98ce\u9669\u6e05\u7406\u9879\uff0c\u786e\u8ba4\u540e\u5148\u79fb\u5230\u9694\u79bb\u533a\u3002",
            "\u4f1a\u53d1\u751f\u4ec0\u4e48\uff1a\u5904\u7406 " + affectedDescription + "\uff0c\u9884\u8ba1\u91ca\u653e " + impact + "\u3002",
        ...
        var outcomePreviewLines = new[]
        {
            ...
            isCommunityExactFiles
                ? "\u793e\u533a\u89c4\u5219\u53ea\u63d0\u4f9b\u5019\u9009\uff1b\u5f53\u524d\u89c4\u5219\u7248\u672c\u3001\u5e94\u7528\u8eab\u4efd\u6216\u4efb\u4e00\u6587\u4ef6\u53d8\u5316\u65f6\uff0c\u65e7\u65b9\u6848\u4f1a\u7acb\u5373\u505c\u6b62\u3002"
                : "\u5904\u7406\u524d\u4f1a\u91cd\u65b0\u786e\u8ba4\u5e94\u7528\u548c\u7f13\u5b58\u4f4d\u7f6e\uff1b\u8bc1\u636e\u53d8\u5316\u65f6\u65e7\u65b9\u6848\u4f1a\u505c\u6b62\u3002",
